 ...
 * 类说明：
 */
public class GoodOwner_Fragment extends Fragment implements LocationSource, AMapLocationListener,AMap.OnMarkerClickListener, AMap.InfoWindowAdapter, TextWatcher,
    ...
    private Button btn_speedpick;
    private Button ben_slowpick;
    //poikeyowrd搜索
    ...
    private static boolean checkpoint = true;//true为目的地，false为出发点
   ...
   // private static boolean checkthread = true;
     ...
     * @return A new instance of fragment GoodOwner_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static GoodOwner_Fragment newInstance(String param1, String param2) {
        GoodOwner_Fragment fragment = new GoodOwner_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_good_owner_, container, false);
        //fab.setAnimation(AnimationUtils.loadAnimation(getTargetFragment(),R.animator.scale_up));
        //点击fab按钮，显示or隐藏layout；
        ...
        btn_speedpick = (Button) view.findViewById(R.id.btn_speedpick);
        ben_slowpick = (Button)view.findViewById(R.id.ben_slowpick);
        btn_startsearch.setOnClickListener(this);
        searchText.addTextChangedListener(this);// 添加文本输入框监听事件

        //设置监听器
        btn_speedpick.setOnClickListener(this);
        ben_slowpick.setOnClickListener(this);
...
//        }).start();
    ...
    private void initMap() {
     //   Toast.makeText(getActivity().getApplicationContext(), "默认Toast样式2",
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.edt_destination:
                ...
                break;
            case R.id.btn_speedpick:
                if(mStartPoint != null) {
                    if(isChangePoint){
                        Intent intent = new Intent(getActivity(),OrderDetails_Activity.class);
        ...
        if (errorCode == 1000) {
            if (result != null && result.getPaths() != null) {
                if (result.getPaths().size() > 0) {
                    ...
                    Toast.makeText(getActivity().getApplication(),"总里程为："+drivePath.getDistance()+"米",Toast.LENGTH_SHORT).show();
